...
#col[
  ...
  In the first two weeks of July I conducted four user tests with friends on discord calls and also other students from our faculty. The results were mostly positive, with multiple people being so engaged, that they ended up completing more levels than asked.

  === Documentation <david_doc>
  Looking back at the Development Phase I was really dissappointed with myself and the work I had put towards the project. In an attempt to regain my focus and put a more adequate amount of time into the documentation I decided to start tracking my time separately and focus more on myself. Watching other team members get back on track and contribute more consistently after some of the changes we made, while I was still struggling with the same issues was really frustrating and I thought this change would help mitigate that.
  ...
  On July, 13th we had a team meeting where we talked more in depth about the structure. We decided to change some of the already existing sections to fit more into our new structure and also ended up removing some parts. We changed the section about the implementation to inculde Challenges and Solutions, so I revised some of the texts I had already written and added more sections to it. I ended up writing the sections from `Game` to `Node Editor`. I also wrote a small section in the `User Testing` section about tracking player behaviour.
