== Contributions of Markus Heming
  ...
  The development was kind of rough and slow in the beginning, which for me was mainly due to two reasons: First, during the project planning phase we as a team agreed on setting up the development environment all together so everyone knows how to setup the project on his computer and so all teammembers are certain about the architecture of the project. However, due to the lack of communication this didn't work out as planned. The second reason I was slow on the game development at the beginning was because I was part of the game design and game creation time but not the node team. This meant that I had to wait for the node team to get basic functionality in nodes done in order to be able to test the game node interaction.
