...
#col[
  ...
  The development was kind of rough and slow in the beginning, which for me was mainly due to two reasons: First, during the project planning phase we as a team agreed on setting up the development environment all together so everyone knows how to setup the project on his computer and so all teammembers are certain about the architecture of the project. However, due to the lack of communication this didn't work out as planned. The second reason I was slow on the game development at the beginning was because I was part of the game design and game creation team but not the node team. This meant that I had to wait for the node team to get basic functionality in nodes done in order to be able to test the game node interaction.
  However, I used the time to work my self into the kaplay game engine to get a better understanding of how to use it and how to make it interact with the nodes. This also gave me a perspective on what levels are actually possible and how to implement them.
  ...
  More to the end of the project I was a little bit involved in the documentation part even though I was not assigned to it. I checked for content and typos and put in a little bit of content myself, the most part was done by Leo Kling though.
