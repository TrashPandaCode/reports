...
#col[
  ...
  *Example:*\
  ...
  #todo("hier nochmal gucken und ggf den codeblock rauswerfen, fand ich aber eigentlich ganz schick")
  // Updated by Mister P.
  ...
  *Considerations:*\
  The architecture is optimized for educational/demo use, with future expansion possible for real-time collaboration or backend persistence.
  === Class Diagrams
  #todo("diagramme")
  ...
  *Motivation:*\
  ...
  #todo("hier auch nochmal drüber gucken bitte")
