...
#table(
  ...
  [6. User completes an task],
  [Task Completion (out)],
  [Save progress, update user stats, and display success or error messages.],
...
#col[
  ...
  + *Debugging Node Graphs*:
    ...
    #todo(
      "wahrscheinlich will der nazari mehr scenarios und idk ob die perspektive der narrative so funktioniert. das beispiel aus dem report macht das mit einer 'kunstfigur' mary und aus ihrer perspektive",
    )
