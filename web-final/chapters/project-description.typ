...
#col([
  ...
  *16.07. - 25.07.:* *Presentation & Delivery*
  ...
  #table(
    ...
    [Task], [Project setup, navigation structure, game objects restructure],
    [Start Date], [01.05.2025],
    [End Date], [07.05.2025],
    [Result], [Basic project skeleton with working navigation],
    [Dependencies], [None],
    [Start/End Conditions], [Project start / Structure running in browser],
  )
  ...
  #table(
    ...
    [Task], [Node connections, keyboard shortcuts, basic gameplay architecture],
    [Start Date], [08.05.2025],
    [End Date], [18.05.2025],
    [Result], [Functional core system and basic levels],
    [Dependencies], [Requirements Analysis completed],
    [Start/End Conditions], [Project structure exists / Nodes and interactions working],
  )
  ...
  #table(
    ...
    [Task], [Undo/redo, loop nodes, context menus, tooltips],
    [Start Date], [19.05.2025],
    [End Date], [25.05.2025],
    [Result], [Core editor features functioning],
    [Dependencies], [Architecture ready],
    [Start/End Conditions], [Editor usable / Features testable],
  )
  ...
  #table(
    ...
    [Task], [Feedback collection, UI adjustments, next iteration preparation],
    [Start Date], [26.05.2025],
    [End Date], [31.05.2025],
    [Result], [Polished UI, feedback incorporated],
    [Dependencies], [Implementation complete],
    [Start/End Conditions], [System running / Ready for next iteration],
  )
  ...
  #table(
    ...
    [Task], [Improve tutorials, navigation, FAQ, polish visuals],
    [Start Date], [01.06.2025],
    [End Date], [07.06.2025],
    [Result], [Improved usability, consistent styling],
    [Dependencies], [Previous iteration complete],
    [Start/End Conditions], [Working version / Improved user flow],
  )
  ...
  #table(
    ...
    [Task], [Level difficulty, gravity nodes, solution systems],
    [Start Date], [08.06.2025],
    [End Date], [18.06.2025],
    [Result], [Playable and validated levels],
    [Dependencies], [Refined UI/UX],
    [Start/End Conditions], [System stable / Levels finished],
  )
  ...
  #table(
    ...
    [Task], [Add tests, clean ESLint, expand guides, FAQs],
    [Start Date], [19.06.2025],
    [End Date], [26.06.2025],
    [Result], [Code quality ensured, documentation expanded],
    [Dependencies], [Implementation complete],
    [Start/End Conditions], [Stable build / All features covered by tests],
  )
  ...
  #table(
    ...
    [Iteration], [2],
    [Phase], [Review & Planning],
    [Task], [Final feedback, next steps defined],
    [Start Date], [27.06.2025],
    [End Date], [30.06.2025],
    [Result], [Iteration retrospective, planning adjusted],
    [Dependencies], [All work in iteration done],
    [Start/End Conditions], [Iteration 2 complete / Ready for final iteration],
  )
  ...
  #table(
    ...
    [Task], [FAQ updates, minor bugs, final adjustments],
    [Start Date], [01.07.2025],
    [End Date], [07.07.2025],
    [Result], [Product feature-complete, minor fixes closed],
    [Dependencies], [Iteration 2 complete],
    [Start/End Conditions], [Stable version / Ready for final QA],
  )
  ...
  #table(
    ...
    [Iteration], [3],
    [Phase], [Testing & QA],
    [Task], [Final tests, bug fixing, documentation polish],
    [Start Date], [08.07.2025],
    [End Date], [15.07.2025],
    [Result], [Polished, error-free build],
    [Dependencies], [All features finished],
    [Start/End Conditions], [All tests green / Ready for delivery],
  )
  ...
  #table(
    ...
    [Task], [Prepare demo, finalize documentation],
    [Start Date], [16.07.2025],
    [End Date], [25.07.2025],
    [Result], [Final deliverables prepared, presentations ready],
    [Dependencies], [Product complete, tests passed],
    [Start/End Conditions], [QA passed / Hand-off complete],
  )
